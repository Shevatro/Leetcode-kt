...
class Task39_7 {
    ...
    private class Solution(
        ...
        private val pickedItems = LinkedList<Int>()
        ...
        private fun backtrack(i: Int, curBudget: Int, curRating: Double) {
            if (i == prices.size) {
            ...
            if (newBudget <= budget) {
                //do
                pickedItems.addLast(i)

                backtrack(i + 1, newBudget, curRating + ratings[i]) // pick

                //undo
                pickedItems.removeLast()
            }

            backtrack(i + 1, curBudget, curRating) // skip
        }
    }
}
    ...
    companion object {
        ...
        private fun inputDataProvider(): Stream<Arguments> {
            return Stream.of(
                ...
                Arguments.of(10, listOf(6, 5, 5), listOf(9.0, 8.0, 8.0), listOf(1, 2))
            )
        }
    }
}